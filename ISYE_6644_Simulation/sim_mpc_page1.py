...
def review_questions():
    ...
    st.markdown("### Please select a module to proceed:")

    module_mapping = {
        "Module 0: Introduction + Bootcamps": '0',
        "Module 1: Probability Basics": '1',
        "Module 2: Random Variables": '2',
        "Module 3: Bivariate Random Variables": '3',
        "Module 4: Distributions + Central Limit Theorem": '4',
        "Module 5: Statistics Basics + Estimation": '5',
        "Module 6: Confidence Intervals": '6',
        "Module 7: Hypothesis Testing": '7',
        "Module 8: Regression": '8'
    }
