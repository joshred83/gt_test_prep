question_gatech_MDP_1_1 = {
    'question': (
        'Which of the following is NOT a challenge of reinforcement learning as defined in the lectures?'
    ),
    'options_list': [
...
question_gatech_MDP_1_2 = {
    'question': (
        'In the context of Markov Decision Processes (MDPs), which statement is FALSE?'
    ),
    'options_list': [
...
question_gatech_MDP_1_3 = {
    'question': (
        'What is the primary reason dynamic programming methods are difficult to apply directly to reinforcement learning problems?'
    ),
    'options_list': [
